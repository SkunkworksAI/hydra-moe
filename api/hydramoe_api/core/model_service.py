...
@dataclass 
class ModelConfig:
    base_model_path: str = "Skunkworks/Mistralic-7B-1"
...
class ModelService:
    ...
    def init_models(self, config):
        ...
        self.base_model = AutoModelForCausalLM.from_pretrained(config['base_model_path'])
        self.base_tokenizer = AutoTokenizer.from_pretrained(config['base_model_path'])
