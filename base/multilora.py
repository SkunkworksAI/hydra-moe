...
class LoraLayer:
    def __init__(self, in_features: int, out_features: int, **kwargs):
        ...
        self.lora_A_active = nn.Linear(self.in_features, 64, bias=False)
        self.lora_B_active = nn.Linear(64, self.out_features, bias=False)
        self.lora_dropout_active = nn.Dropout(p=0.1)
...
class MultiLoraModel(LoraModel):
    ...
    the model MUST use the Linear, Emb layers in this file for this to work.
    """
...
class Linear(nn.Linear, LoraLayer):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.execute_sequentially = False # experimental sequential execution, probably slower
